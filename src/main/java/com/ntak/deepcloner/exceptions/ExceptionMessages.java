...
public class ExceptionMessages {
	...
	public static final String EXC_CLONE_RULE_NESTED_EXCEPTION = "Exception thrown while cloning process was attempted for clone rule: %s. Nested exception message: %s:%s";
